...
**Q3: In neural networks, what do we mean by mini-batch and epoch?** p. 125: A *mini-batch* is a small subset of the full dataset, typically containing $n_b = 10$, $n_b = 100$, or $n_b = 1{,}000$ observations.
