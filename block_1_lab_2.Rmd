...
# c. Decision tree with minimum deviance (minsplit) = 0.0005
# Note: rpart's control parameter minsplit expects an integer; deviance threshold is controlled differently by 'cp'
# To approximate minimum deviance, adjust 'cp' (complexity parameter)
...
# (Optional) reset layout to default after plotting
par(mfrow = c(1, 1))
...
# build data.frame of train/valid misclassification
